...
$config = array(
    ...
    "key"              => "urFuWWVGSSO49K5GIX4d1n7fVrg0EGGkLvVsMDtpE0WB19B7", //Enter your consumer key here
    "secret"           => "Jo3JaIlTsEHsu13rs0JGR4flzfafP3GYifWfffwBFZ80GcWXogaIlmSSMpb6slN3", //Enter your consumer secret here
    "username"         => "apitest",
    ...
    "AccountReference" => "Jade Accessories",
    "TransactionDesc"  => "Payment of X" ,
);


if (isset($_POST['phone_number'])) {
    $amount = $_POST['payment_amount']; // Use the amount entered in the form
